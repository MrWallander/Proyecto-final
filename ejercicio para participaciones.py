...
figure= {
    "manzana":os.path.join(BASE_DIR,"manzana.png"),
    "pera":os.path.join(BASE_DIR,"pera.png"),
    "naranja":os.path.join(BASE_DIR,"naranja.png"),
    "uva":os.path.join(BASE_DIR,"uva.png")
}
